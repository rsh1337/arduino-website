				...
				<Flex>
					...
					<Box flex={{ base: '3', lg: '3' }} overflowY="auto" mb={5}>
						<VStack align="left" spacing={5}>
							...
							<Text fontSize="lg">
								Arduino este o platformă open-source utilizată
								pentru construirea de proiecte electronice.
								Arduino constă atât într-o placă de circuite
								programabile fizic ( microcontroler), cât și
								într-o parte de software sau pe scurt IDE
								(Integrated Development Environment) care
								rulează pe computerul dvs. Acesta este folosit
								pentru scrie și încărca codul computerului pe un
								board fizic.
							</Text>
							<Box>
								<Image
							...
							<Text fontSize="lg">
								Acesta este un USB port care este folosit pentru
								a incarca un program de pe aplicatia Arduino IDE
								in placa Arduino. De asemenea placa poate fi
								alimentata prin acest port.
							</Text>
							<Box>
								<Image
							...
							<Heading id="alimentare-externa">
								Alimentarea externa
							</Heading>
							<Text fontSize="lg">
								Placa poate fi alimentata la priza sau cu o
								baterie. Sursa de curent poate fi conectata prin
								intrarea de 2.1mm aflata pe placa.
							</Text>
							<Box>
								<Image
							...
							<Text fontSize="lg">
								Placa Arduino are 6 pini de iesire analog,
								numerotate de la A0 la A5. Cu acesti pini putem
								citi semnalul de la un senzor analog ca de
								exemplu senzorul de temperatura si il putem
								converti intr-o valoare digitala pentru a putea
								fi citit de sistem.
							</Text>
							<Box>
								<Image
							...
							<Text fontSize="lg">
								Acesti pini sunt numerotati de la 2 la 13 si pot
								fi folositi pentru intrare cat si pentru iesire.
								Cand sunt folsiti pentru iesire, ei au rolul de
								a fi o sursa de curent pentru componenta
								conectata la ei. Cand sunt folositi pentru
								intrare, ei au rolul de a citi semnalul
								componentei la care este conectat.
							</Text>
							<Box>
								<Image
							...
							<Heading id="buton-de-reset">
								Butonul de reset
							</Heading>
							<Text fontSize="lg">
								Cand acesta este apasat, ruleaza programul iara
								de la inceput. Acesta este folositor cand codul
								pe care il avem nu se repeta.
							</Text>
							<Box>
								<Image
							...
							<Text fontSize="lg">
								Mai jos o sa ai un mini tutorial cum sa
								instalezi software-ul Arduino IDE pas cu pas.
							</Text>
							<Link
								href="https://www.arduino.cc/en/software"
								isExternal
							>
								Link catre site-ul Arduino{' '}
							...
							<Carousel showThumbs={false}>
								...
								<Box>
									...
									/>
									<Text className="legend">
										Apasam click pe prima optiune de
										download
									</Text>
								</Box>
								<Box>
									...
									/>
									<Text className="legend">
										Apasam pe butonul unde scrie JUST
										DOWNLOAD si dechidem aplicatia
									</Text>
								</Box>
								<Box>
									<Image
									...
									/>
									<Text className="legend">
										Acceptam termenii si conditiile apasand
										pe butonul I Agree
									</Text>
								</Box>
								<Box>
								...
								<Box>
									...
									/>
									<Text className="legend">
										Apasam pe butonul Install pentru a
										instala driverele necesare
									</Text>
								</Box>
								<Box>
									<Image
								...
								<Box>
									...
									/>
									<Text className="legend">
										Apasam pe butonul close si o sa gasim
										aplicatia pe desktop
									</Text>
								</Box>
							</Carousel>
							...
							<Text fontSize="lg">
								Acest driver este pentru cei care folosesc o
								clona arduino pentru a face posibila utilizarea
								aplicatiei Arduino IDE cu aceasta
							</Text>
							<Link
								href="https://www.win-rar.com/download.html?&L=0"
								isExternal
							>
								In acest tutorial a mai fost folosita aplicatia
								WinRAR
								<ExternalLinkIcon mx="2px" />
							</Link>
							<Link
							...
							<Link
								href="/driver/Driver_Arduino_Fake.zip"
								isExternal
							>
								Link Descarcare Driver{' '}
								<ExternalLinkIcon mx="2px" />
							</Link>
							<Carousel showThumbs={false}>
								<Box>
									...
									/>
									<Text className="legend">
										Apasam click pe textul albastru unde
										scrie Windows CH340 Driver
									</Text>
								</Box>
								<Box>
									<Image
								...
								<Box>
									...
									/>
									<Text className="legend">
										Apasam pe ok si mergem in folderul de
										downloads
									</Text>
								</Box>
								<Box>
									...
									/>
									<Text className="legend">
										Intram in folderul care a fost extras
										din fisier
									</Text>
								</Box>
								<Box>
								...
								<Box>
									...
									/>
									<Text className="legend">
										Apasam pe OK si iesim din aplicatie
										apasand butonul X
									</Text>
								</Box>
							</Carousel>
